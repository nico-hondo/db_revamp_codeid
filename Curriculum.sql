...
(1, 'Programming fundamentals', 'Yes', 'None', 'This module covers the basics of programming, including variables, control flow, and data structures.', 'Beginner'),
(2, 'Database management', 'Yes', 'Basic knowledge of SQL', 'This module focuses on database management, including designing schemas, writing queries, and optimizing performance.', 'Intermediate'),
(3, 'Web development', 'No', 'Front-end development experience', 'This module delves into web development, covering HTML, CSS, JavaScript, and frameworks like React or Angular.', 'Advanced')
